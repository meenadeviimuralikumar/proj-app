...
html_option1 = f"""
<h5 style="text-align: center">User_Rated_Sexism &ensp; ~ &ensp; {iv1} &ensp; </h5>
<br>
...
<br>
<p style ="text-align:center;font-style:italic">Does alignment between user ratings of sexism and {model} {attr} scores vary across the different communities?</p>
"""
...
st.markdown(html_option1, unsafe_allow_html=True)
